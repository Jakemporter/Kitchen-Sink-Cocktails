...
function ingredientSearch() {
    var apiCall = 'https://cors-anywhere.herokuapp.com/http://www.thecocktaildb.com/api/json/v1/1/filter.php?i=' + searchInput;
    console.log(apiCall);
    fetch(apiCall)
...
function nameSearch() {
    var apiCall = 'https://cors-anywhere.herokuapp.com/http://www.thecocktaildb.com/api/json/v1/1/search.php?s=' + searchInput;
    console.log(apiCall);
    fetch(apiCall)
        .then(function (response) {
            return response.json();
